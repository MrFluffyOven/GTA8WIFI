...
BOARD_KERNEL_CMDLINE += androidboot.selinux=enforce androidboot.init_fatal_reboot_target=recovery androidboot.mode=recovery
...
TW_DEVICE_VERSION := X200XXS3DXD5(2.6.3A)
