...
BOARD_KERNEL_CMDLINE += androidboot.selinux=enforce androidboot.init_fatal_reboot_target=recovery androidboot.mode=normal
...
TW_DEVICE_VERSION := support x200-205 stable A14
